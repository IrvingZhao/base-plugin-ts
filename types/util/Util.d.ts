export declare class UtilInstance {
     ...
     * @return Array 树型数据
     */
    public static generateTree(data: any[], parentNodeKey: string, mapCache?: any, idKey?: string, parentKey?: string, childrenKey?: string): any[];
     ...
     */
    public static getTreePath(data: any, fromId: string, pushId?: string, parentNode?: string): any[];
     ...
     */
    public static setCurrentAndChildProp(current: any, propKey: string, propValue: any, childrenNode?: string): void;
     ...
     * @return Array 属性列表
     */
    public static getCurrentAndChildProp(current: any, propKey: string, childrenNode?: string): any[];
